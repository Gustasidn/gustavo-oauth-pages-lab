export async function onRequestGet(context) {
  ...
  if (provider === "google") {
    ...
    if (!tokenRes.ok || !tokenData.id_token) {
      return new Response("Falha na troca de código do Google", { status: 400 });
    }
    ...
    if (!tokenRes.ok || !tokenData.access_token) {
      return new Response("Falha na troca de código do GitHub", { status: 400 });
    }
  ...
  return new Response(null, {
    ...
    headers: {
      ...
      "Set-Cookie": [sessionCookie, clearTempCookie],
